...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "234b39f09e34901c528fb4c54928650b";
    ...
    public void updateUI(WeatherDataModel weatherData){
        ...
        int ressourceID = getResources().getIdentifier(weatherData.getIconName(), "drawable",   getPackageName());
        mWeatherImage.setImageResource(ressourceID);
    }
